...
States in classical planning problems are represented by a conjunction of positive literals. Specifically, first-order propositional literals, which must be ground and function free. Classical planning makes use of the closed-world assumption, which states that any literals which are not explicitly enumerated as part of the state are false.